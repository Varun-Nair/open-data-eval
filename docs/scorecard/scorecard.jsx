...
function App() {
  ...
  return (
    <div style={{ maxWidth:1200, margin:"0 auto", padding:"24px 20px", fontFamily:"var(--font)" }}>
      ...
      {/* page header */}
      <div style={{ marginBottom:20, paddingBottom:16, borderBottom:"1px solid var(--c-border)" }}>
        <div style={{ display:"flex", alignItems:"center", gap:10, flexWrap:"wrap" }}>
          <img src="./logo.svg" alt="Open Data Eval logo"
            style={{ height:36, width:"auto", display:"block", flexShrink:0 }} />
          <h1 style={{ fontSize:24, fontWeight:800, margin:0, color:"var(--c-text-1)", letterSpacing:"-0.5px" }}>
            Open Data Eval
          </h1>
          <span style={{ marginLeft:"auto", fontSize:11, fontWeight:500, color:"var(--c-text-2)",
            padding:"2px 8px", borderRadius:20,
            background:"var(--c-track)", border:"1px solid var(--c-border)" }}>
            16 datasets · ISO 5259-2
          </span>
        </div>
