...
PAPER_METADATA = {
    "Ego4D": {
        ...
        "annotation_notes": "3.85M timestamped narrations = 100% of 3670h. Gaze: 80h (2.2%). 3D: 612h (17%). Stereo: 491h (13%). FHO benchmark: 116h.",
    ...
    "Ego-Exo4D": {
        ...
        "fps_override": None,                   # truly varies: Aria=30fps, GoPro=60fps
    ...
    "HD-EPIC": {
        ...
        "calibration_tier": None,               # not confirmed — HD-EPIC paper not read; null
        "calibration_notes": "Not confirmed. HD-EPIC extends EPIC-KITCHENS footage; EPIC-Fields calibration may apply. Requires paper verification.",
        "lens_type": "rectilinear",             # inferred from EPIC-KITCHENS family
    ...
    "Xperience-10M": {
        # No formal paper as of April 2026; blog post only
        "capture_device": None,                # no paper to verify
        "calibration_tier": None,
        "calibration_notes": "No formal paper published as of April 2026. Technical capture details unavailable.",
        "lens_type": None,
        "fov_degrees": None,
        ...
        "download_size_gb": 1000000,           # catalog: ~1 PB
        "geo_locations": None,
        "paper_ref": None,
    },
    "OpenEgo": {
        # arXiv 2509.05513
        "capture_device": "Multiple (aggregated: EPIC-KITCHENS, HOI4D, and other source datasets)",
        "calibration_tier": None,              # heterogeneous sources, no unified calibration
        "calibration_notes": "Aggregated from multiple heterogeneous source datasets. No unified calibration layer.",
        "lens_type": "varies",
        "fov_degrees": None,
        "resolution_override": None,           # genuinely varies
        "fps_override": None,
        "annotation_coverage": None,
        "annotation_notes": None,
        "download_size_gb": None,
    ...
    "HOI4D": {
        ...
        "lens_type": None,                     # not stated in paper
        "fov_degrees": None,
    ...
    "ARCTIC": {
        ...
        "lens_type": None,                     # RGB camera model not stated
        "fov_degrees": None,
    ...
    "EgoDex": {
        ...
        "lens_type": None,                     # Apple proprietary cameras; not stated in paper
        "fov_degrees": None,
...
def score_accessibility(row):
    ...
    comm_s = 0.5 if comm == 'Yes' else (0.25 if comm == 'No' else 0.0)
...
def build_qp(row, max_scenes, max_demo_product):
...
def generate_scorecard_data_js(qps, path):
    ...
    def parse_citations(s):
        ...
        import re
        m = re.search(r'(\d+)', re.sub(r'[~,<>+\s]', '', str(s)))
    ...
    for qp in qps:
        ...
        entries.append({
            ...
            "citations":    parse_citations(p["context"].get("approximate_citations", "")),
        })
...
def main():
    ...
    qps = [build_qp(r, max_scenes, max_product) for r in target_rows]
